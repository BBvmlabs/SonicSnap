...
class AlbumDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          const Color(0xFFF2F2F7), // Light background like screenshot? Or Dark?
      // Screenshot shows light/gradient background. I'll make it adapts to dark mode or keep it dark for consistency unless user wants light mode.
      // Screenshot 0 looks Light Mode. But app is Dark Mode. I will adapt to Dark Mode using light purple gradients to match the "Vibe".
      body: Container(
